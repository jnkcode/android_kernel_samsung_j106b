...
int soc_val = 0;
#if defined(CONFIG_MACH_J1POP3G) || defined(CONFIG_MACH_J1MINI3G) || defined(CONFIG_MACH_J1MINIVE3G) \
	|| defined(CONFIG_MACH_J3X3G) || defined(CONFIG_MACH_J1X3G) || \
...
#define PDATA_LOG(format, arg...) printk("sprdbat pdata: " format, ## arg)
	...
	defined(CONFIG_MACH_GRANDPRIMEVE3G) || defined(CONFIG_MACH_J1MINI3G) || defined(CONFIG_MACH_J1MINIVE3G) \
   	|| defined(CONFIG_MACH_J3X3G) || defined(CONFIG_MACH_J1X3G) || \
	defined(CONFIG_MACH_GTEXSWIFI)
...
#if defined(CONFIG_MACH_J1POP3G) || defined(CONFIG_MACH_J1MINI3G) || defined(CONFIG_MACH_J1MINIVE3G) \
	|| defined(CONFIG_MACH_J1X3G) || defined(CONFIG_MACH_J3X3G) || \
	defined(CONFIG_MACH_GTEXSWIFI)
