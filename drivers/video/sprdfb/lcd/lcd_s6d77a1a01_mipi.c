/* drivers/video/sprdfb/lcd_s6d77ala_mipi.c
 *
 * Support for s6d77ala mipi LCD device
 *
...
static int32_t s6d77ala_mipi_init(struct panel_spec *self)
{
	int32_t i = 0;
	...
	printk("kernel s6d77ala_mipi_init\n");
...
static uint32_t s6d77a1a01_readid(struct panel_spec *self)
{
	...
	mipi_eotp_set(0,0);
	LCD_PRINT("lcd_s6d77a1a01_mipi read id fail! 0xda,0xdb,0xdc is 0x%x,0x%x,0x%x!\n",read_data[0],read_data[1],read_data[2]);
	return 0;
}


static int32_t s6d77ala_enter_sleep(struct panel_spec *self, uint8_t is_sleep)
{
	int32_t i = 0;
	...
	printk("kernel s6d77ala_enter_sleep, is_sleep = %d\n", is_sleep);
...
static struct panel_operations lcd_s6d77ala_mipi_operations = {
	.panel_init = s6d77ala_mipi_init,
	.panel_readid = s6d77a1a01_readid,
	.panel_enter_sleep = s6d77ala_enter_sleep,
};

static struct timing_rgb lcd_s6d77ala_mipi_timing = {
	.hfp = 126,  /* unit: pixel */
	.hbp = 150,
	.hsync = 40,
	.vfp = 8, /*unit: line*/
...
static struct info_mipi lcd_s6d77ala_mipi_info = {
	...
	.timing = &lcd_s6d77ala_mipi_timing,
	.ops = NULL,
};

struct panel_spec lcd_s6d77ala_mipi_spec = {
	.width = 480,
	.height = 800,
	.fps	= 60,
	.type = LCD_MODE_DSI,
	...
	.is_clean_lcd = true,
	.info = {
		.mipi = &lcd_s6d77ala_mipi_info
	},
	.ops = &lcd_s6d77ala_mipi_operations,
};
struct panel_cfg lcd_s6d77ala_mipi = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x77a108,
	.lcd_name = "lcd_s6d77ala_mipi",
	.panel = &lcd_s6d77ala_mipi_spec,
};

//temp code
static int __init lcd_s6d77ala_mipi_init(void)
{
/*
	printk("s6d77ala_mipi_init: set lcd backlight.\n");
...
*/
	...
	return sprdfb_panel_register(&lcd_s6d77ala_mipi);
}

subsys_initcall(lcd_s6d77ala_mipi_init);
