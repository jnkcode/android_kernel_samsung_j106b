...
#ifdef CONFIG_FB_SC9001
	dispc_set_bits((1<<20), DISPC_CTRL);
#endif
	return ret;
}
...
#if CONFIG_HOP_FREQ_SCALING
		dlter_freq = panel->info.mipi->dlter_freq;
#endif
		old_val = panel->info.mipi->phy_feq_current;
