...
static int32_t isp_module_eb(struct isp_k_file *file)
{
	...
	#if defined(CONFIG_MACH_SP7731CEA) || defined(CONFIG_MACH_SP7731CEB) || defined(CONFIG_MACH_PIKEB_J1MINI_3G) || defined(CONFIG_MACH_PIKEB_J1_3G) || defined(CONFIG_MACH_PIKEB_JIGBASE)|| defined(CONFIG_MACH_SP7727SEEB_PRIME) || defined(CONFIG_MACH_PIKEB_Z1MINI) || defined(CONFIG_MACH_J1MINIVE3G)  
