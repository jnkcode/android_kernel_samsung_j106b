...
#if defined(CONFIG_SEC_DEBUG) || defined(CONFIG_SEC_DEBUG64)
...
#if defined(CONFIG_SEC_DEBUG) || defined(CONFIG_SEC_DEBUG64)  // send dummy release event to avoid invalid key crash case
